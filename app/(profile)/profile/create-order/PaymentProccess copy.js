        ...
        <div className="my-10 max-w-xl mx-2 md:mx-auto p-2 md:p-6 bg-white shadow-lg rounded-xl border border-blue-200">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
                ...
                {/* Submit Button */}
                {
                    <button
                        type="submit"
                        className={`w-full text-sm ${isProfileMatch ? "bg-blue-600 hover:bg-blue-700 cursor-pointer" : "bg-red-200 cursor-no-drop"} text-white font-semibold py-2 px-4 rounded-lg shadow-md transition duration-200 ease-in-out transform hover:scale-[1.01]`}
                        disabled={waiting || !isProfileMatch}
                    >
