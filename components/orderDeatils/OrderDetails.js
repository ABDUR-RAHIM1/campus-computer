...
export default async function OrderDetails({ data }) {
    ...
    const { 
        profileId,     // এর ভেতরে আছে studentName, institute, registrationNumber ইত্যাদি
        serviceId,     // এর ভেতরে আছে title, description
        reference,     // এর ভেতরে আছে username, phone, role
        paymentStatus, 
        totalFee, 
        collegeFee,
        chargeFee,
