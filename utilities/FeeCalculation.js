...
export const feeCalculation = (collegeFee = 0, subjectFee = 0, processingFee = 0, testExamFee = 0, chargeFee = 0) => {

    // : subtotal
    const subTotal = Number(collegeFee) + Number(subjectFee) + Number(processingFee) + Number(testExamFee) + Number(chargeFee);
